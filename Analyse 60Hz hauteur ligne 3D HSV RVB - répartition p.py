...
image1 = cv2.imread('C:/image 1.jpg')
...
fig = plt.figure()
canal_vert = img_rgb_filtree[:, :, 1] * 255
...
# Affichage pourcentage valeur absolue sans virgule, au dessus/dessous 71 
titre_graphe = ["Canal vert filtre aspiration ",str(round(prc_pixels_au_dessus_71)), '%'];
...
for angle in range(0, 90):
 ...
 #  plt.savefig(fname=f"fig_ang_{angle}.png")
plt.show()
...
Y = canal_vert[218, :] # Axe horizontal
